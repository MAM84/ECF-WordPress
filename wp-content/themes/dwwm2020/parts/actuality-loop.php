<article class="card">
    <?php echo wp_get_attachment_image(get_field('photo'),'medium', "", ["class" => "card-img"]);?>
    <div class="card-content">
        <p class="card-date"><time datetime="<?php echo get_field('date') ?>"><?php echo get_field('date') ?></time></p>
